                    ...
                    >
                      {payload?.map((entry, index) => {
                        ...
                        return (
                          <li
                            key={`legend-${index}`}
                            className="flex items-center gap-2 cursor-pointer focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 rounded px-2 py-1 transition-all hover:bg-green-100 dark:hover:bg-green-900/20"
                            tabIndex={0}
                            role="button"
